...
uses
  ...
  FireDAC.Comp.Client, PersonBO, System.Generics.Collections, FireDAC.UI.Intf,
  FireDAC.Stan.Def,
...
type
  ...
  public
    ...
    function FindPeople(ASearchText: String; APage: Integer)
      : TObjectList<TPerson>;
...
function TPeopleModule.FindPeople(ASearchText: String; APage: Integer)
  : TObjectList<TPerson>;
var
...
begin
  ...
  qryPeople.Open('SELECT * FROM PEOPLE WHERE ' +
    ...
    'EMAIL CONTAINING :SEARCH_TEXT_3 ' + 'ORDER BY LAST_NAME, FIRST_NAME ' +
    Format('ROWS %d TO %d', [StartRec, EndRec]), [ASearchText, ASearchText,
    ASearchText]);
...
begin
  ...
  TFireDACUtils.ObjectToParameters(UpdCommand.Params, APerson, 'NEW_');
